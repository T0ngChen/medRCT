...
First of all, thanks for considering contributing to medRCT! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on medRCT. 😊

medRCT is an open source project, maintained by people who care. We are
not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://t0ngchen.github.io/medRCT/CODE_OF_CONDUCT.md). By
...
Think medRCT is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using medRCT for a paper you are writing? Consider [citing
it](https://t0ngchen.github.io/medRCT/authors.html).

### Ask a question ⁉️

Using medRCT and got stuck? Browse the
[documentation](https://t0ngchen.github.io/medRCT) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/t0ngchen/medRCT/issues/new). While we cannot
...
<tong.chen@mcri.edu.au>.

### Propose an idea 💡

Have an idea for a new medRCT feature? Take a look at the
[documentation](https://t0ngchen.github.io/medRCT) and [issue
list](https://github.com/t0ngchen/medRCT/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/t0ngchen/medRCT/issues/new). While we can’t
...
Using medRCT and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/t0ngchen/medRCT/issues/new) so we can fix it.
A good bug report makes it easier for us to do so, so please include:
...
[This website](https://t0ngchen.github.io/medRCT) is generated with
...
issue](https://github.com/t0ngchen/medRCT/issues/new) and we can point
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/t0ngchen/medRCT).
...
Care to fix bugs or implement new functionality for medRCT? Awesome! 👏
Have a look at the [issue
list](https://github.com/t0ngchen/medRCT/issues) and leave a comment on
...
1.  Fork [this repo](https://github.com/t0ngchen/medRCT) and clone it to
