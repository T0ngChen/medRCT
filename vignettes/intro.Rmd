...
The `medRCT` package is designed to handle complex mediation settings involving **multiple interrelated mediators** and **intermediate confounders** (exposure-induced mediator-outcome confounders). It supports a range of variable types. Specifically, it supports **categorical exposures** with two or more levels (Levels $\geq$ 2). For the **outcome variable**, `medRCT` supports both **binary** and **continuous** outcomes. Additionally, it supports any number of mediators. Each **mediator**, including those not of primary interest (i.e., **intermediate confounders**), can be either **binary** or **continuous**. Any number of **baseline confounders** and of any type are supported. This makes the package suitable for a broad range of real-world applications in epidemiology, public health, and social science research. 
